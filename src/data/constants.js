export const Bio = {
  ...
  github: "https://github.com/CYBERCODERoss",
  resume:
  ...
  twitter: "https://twitter.com/CYBERCODERoss",
...
export const experiences = [
  ...
  },
  {
    ...
    desc: "Working on the backend of the web application using NodeJs, ExpressJs, and MongoDB.",
    skills: [
      "NodeJs",
      "ExpressJs",
      "MongoDB",
  ...
  },
  {
    ...
    desc: "Built an AI based chatbot using NodeJs, ExpressJs, and MongoDB.",
    skills: [
      "NodeJs",
      "ExpressJs",
      "HTML",
  ...
  },
  {
    ...
    desc: "Working on cloud infrastructure and automation using Terraform, Docker, and Kubernetes.",
    skills: [
      "Terraform",
      "Docker",
      "Kubernetes",
  ...
  },
  {
    ...
    role: "Jr. DevOps and Cloud Engineer",
    company: "Antematter",
    date: "Jan 2025 - Present",
    desc: "Working on deployments, cloud infrastructure and automation using Terraform, Docker, and Kubernetes.",
    skills: [
      "Terraform",
      "Docker",
      "Kubernetes",
...
export const projects = [
  {
    ...
    category: "DevSecOps",
    github: "https://github.com/CYBERCODERoss/NETFLIXclone",
